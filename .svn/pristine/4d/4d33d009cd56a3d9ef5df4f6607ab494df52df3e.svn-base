 ...
 */
public class NotDocumentImpl extends com.kyt.xsd.widgettree.impl.AllConditionalsDocumentImpl implements com.kyt.xsd.widgettree.NotDocument
{
     ...
     */
    public com.kyt.xsd.widgettree.NotDocument.Not getNot()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgettree.NotDocument.Not target = null;
            target = (com.kyt.xsd.widgettree.NotDocument.Not)get_store().find_element_user(NOT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setNot(com.kyt.xsd.widgettree.NotDocument.Not not)
    {
     ...
     */
    public com.kyt.xsd.widgettree.NotDocument.Not addNewNot()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgettree.NotDocument.Not target = null;
            target = (com.kyt.xsd.widgettree.NotDocument.Not)get_store().add_element_user(NOT$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class NotImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgettree.NotDocument.Not
    {
        private static final long serialVersionUID = 1L;
