 ...
 */
public class AuxiliaryValueGetterDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetscreen.AuxiliaryValueGetterDocument
{
    ...
    public com.kyt.xsd.widgetscreen.AuxiliaryValueGetterDocument.AuxiliaryValueGetter getAuxiliaryValueGetter()
    {
        synchronized (monitor())
        {
            ...
            target = (com.kyt.xsd.widgetscreen.AuxiliaryValueGetterDocument.AuxiliaryValueGetter)get_store().find_element_user(AUXILIARYVALUEGETTER$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.kyt.xsd.widgetscreen.AuxiliaryValueGetterDocument.AuxiliaryValueGetter addNewAuxiliaryValueGetter()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.AuxiliaryValueGetterDocument.AuxiliaryValueGetter target = null;
            target = (com.kyt.xsd.widgetscreen.AuxiliaryValueGetterDocument.AuxiliaryValueGetter)get_store().add_element_user(AUXILIARYVALUEGETTER$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class AuxiliaryValueGetterImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetscreen.AuxiliaryValueGetterDocument.AuxiliaryValueGetter
    {
        private static final long serialVersionUID = 1L;
