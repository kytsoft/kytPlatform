 ...
 * Localname: label
 * Namespace: 
 * Java type: com.kyt.xsd.widgetscreen.LabelDocument
 *
 ...
 */
public class LabelDocumentImpl extends com.kyt.xsd.widgetscreen.impl.AllWidgetsDocumentImpl implements com.kyt.xsd.widgetscreen.LabelDocument
{
     ...
     */
    public com.kyt.xsd.widgetscreen.LabelDocument.Label getLabel()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.LabelDocument.Label target = null;
            target = (com.kyt.xsd.widgetscreen.LabelDocument.Label)get_store().find_element_user(LABEL$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setLabel(com.kyt.xsd.widgetscreen.LabelDocument.Label label)
    {
     ...
     */
    public com.kyt.xsd.widgetscreen.LabelDocument.Label addNewLabel()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.LabelDocument.Label target = null;
            target = (com.kyt.xsd.widgetscreen.LabelDocument.Label)get_store().add_element_user(LABEL$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class LabelImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetscreen.LabelDocument.Label
    {
        private static final long serialVersionUID = 1L;
