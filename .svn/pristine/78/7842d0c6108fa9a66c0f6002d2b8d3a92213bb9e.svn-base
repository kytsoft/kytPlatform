 ...
 */
public class FieldMapDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgettree.FieldMapDocument
{
     ...
     */
    public com.kyt.xsd.widgettree.FieldMapDocument.FieldMap getFieldMap()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgettree.FieldMapDocument.FieldMap target = null;
            target = (com.kyt.xsd.widgettree.FieldMapDocument.FieldMap)get_store().find_element_user(FIELDMAP$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setFieldMap(com.kyt.xsd.widgettree.FieldMapDocument.FieldMap fieldMap)
    {
     ...
     * This is a complex type.
     */
    public static class FieldMapImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgettree.FieldMapDocument.FieldMap
    {
        private static final long serialVersionUID = 1L;
