 ...
 */
public class UseIteratorDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetform.UseIteratorDocument
{
    ...
    public com.kyt.xsd.widgetform.UseIteratorDocument.UseIterator getUseIterator()
    {
        synchronized (monitor())
        {
            ...
            target = (com.kyt.xsd.widgetform.UseIteratorDocument.UseIterator)get_store().find_element_user(USEITERATOR$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.kyt.xsd.widgetform.UseIteratorDocument.UseIterator addNewUseIterator()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetform.UseIteratorDocument.UseIterator target = null;
            target = (com.kyt.xsd.widgetform.UseIteratorDocument.UseIterator)get_store().add_element_user(USEITERATOR$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class UseIteratorImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetform.UseIteratorDocument.UseIterator
    {
        private static final long serialVersionUID = 1L;
