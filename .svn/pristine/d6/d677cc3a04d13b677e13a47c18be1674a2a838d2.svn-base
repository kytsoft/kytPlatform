 ...
 */
public class AllConditionalsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetscreen.AllConditionalsDocument
{
    private static final long serialVersionUID = 1L;
    
    public AllConditionalsDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
