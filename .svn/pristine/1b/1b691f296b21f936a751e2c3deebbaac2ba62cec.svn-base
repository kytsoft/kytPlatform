 ...
 */
public class ConditionListDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.simplemethods.ConditionListDocument
{
    ...
    public com.kyt.xsd.simplemethods.ConditionListDocument.ConditionList getConditionList()
    {
        synchronized (monitor())
        {
            ...
            target = (com.kyt.xsd.simplemethods.ConditionListDocument.ConditionList)get_store().find_element_user(CONDITIONLIST$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.kyt.xsd.simplemethods.ConditionListDocument.ConditionList addNewConditionList()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.simplemethods.ConditionListDocument.ConditionList target = null;
            target = (com.kyt.xsd.simplemethods.ConditionListDocument.ConditionList)get_store().add_element_user(CONDITIONLIST$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class ConditionListImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.simplemethods.ConditionListDocument.ConditionList
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public com.kyt.xsd.simplemethods.ConditionListDocument.ConditionList.Combine.Enum getCombine()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (com.kyt.xsd.simplemethods.ConditionListDocument.ConditionList.Combine.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public com.kyt.xsd.simplemethods.ConditionListDocument.ConditionList.Combine xgetCombine()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.kyt.xsd.simplemethods.ConditionListDocument.ConditionList.Combine target = null;
                target = (com.kyt.xsd.simplemethods.ConditionListDocument.ConditionList.Combine)get_store().find_attribute_user(COMBINE$6);
                if (target == null)
                {
                    target = (com.kyt.xsd.simplemethods.ConditionListDocument.ConditionList.Combine)get_default_attribute_value(COMBINE$6);
                }
                return target;
            }
        }
         ...
         */
        public void setCombine(com.kyt.xsd.simplemethods.ConditionListDocument.ConditionList.Combine.Enum combine)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetCombine(com.kyt.xsd.simplemethods.ConditionListDocument.ConditionList.Combine combine)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (com.kyt.xsd.simplemethods.ConditionListDocument.ConditionList.Combine)get_store().add_attribute_user(COMBINE$6);
                }
                target.set(combine);
            }
        }
         ...
         */
        public static class CombineImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements com.kyt.xsd.simplemethods.ConditionListDocument.ConditionList.Combine
        {
            private static final long serialVersionUID = 1L;
