 ...
 */
public class AndDocumentImpl extends com.kyt.xsd.widgetscreen.impl.AllConditionalsDocumentImpl implements com.kyt.xsd.widgetscreen.AndDocument
{
     ...
     */
    public com.kyt.xsd.widgetscreen.AndDocument.And getAnd()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.AndDocument.And target = null;
            target = (com.kyt.xsd.widgetscreen.AndDocument.And)get_store().find_element_user(AND$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAnd(com.kyt.xsd.widgetscreen.AndDocument.And and)
    {
        generatedSetterHelperImpl(and, AND$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "and" element
     */
    public com.kyt.xsd.widgetscreen.AndDocument.And addNewAnd()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.AndDocument.And target = null;
            target = (com.kyt.xsd.widgetscreen.AndDocument.And)get_store().add_element_user(AND$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class AndImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetscreen.AndDocument.And
    {
        private static final long serialVersionUID = 1L;
