 ...
 */
public class SetDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.serviceeca.SetDocument
{
     ...
     */
    public com.kyt.xsd.serviceeca.SetDocument.Set getSet()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.serviceeca.SetDocument.Set target = null;
            target = (com.kyt.xsd.serviceeca.SetDocument.Set)get_store().find_element_user(SET$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSet(com.kyt.xsd.serviceeca.SetDocument.Set set)
    {
     ...
     */
    public com.kyt.xsd.serviceeca.SetDocument.Set addNewSet()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.serviceeca.SetDocument.Set target = null;
            target = (com.kyt.xsd.serviceeca.SetDocument.Set)get_store().add_element_user(SET$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class SetImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.serviceeca.SetDocument.Set
    {
        private static final long serialVersionUID = 1L;
        ...
        private static final javax.xml.namespace.QName ENVNAME$2 = 
            new javax.xml.namespace.QName("", "env-name");
        ...
        public java.lang.String getEnvName()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(ENVNAME$2);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public org.apache.xmlbeans.XmlString xgetEnvName()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.XmlString target = null;
                target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(ENVNAME$2);
                return target;
            }
        }
        ...
        public boolean isSetEnvName()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(ENVNAME$2) != null;
            }
        }
        ...
        public void setEnvName(java.lang.String envName)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(ENVNAME$2);
                }
                target.setStringValue(envName);
            }
        }
         ...
         */
        public void xsetEnvName(org.apache.xmlbeans.XmlString envName)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(ENVNAME$2);
                }
                target.set(envName);
            }
        }
        ...
        public void unsetEnvName()
        {
            ...
            {
                check_orphaned();
                get_store().remove_attribute(ENVNAME$2);
            }
        }
         ...
         */
        public com.kyt.xsd.serviceeca.SetDocument.Set.Format.Enum getFormat()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (com.kyt.xsd.serviceeca.SetDocument.Set.Format.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public com.kyt.xsd.serviceeca.SetDocument.Set.Format xgetFormat()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.kyt.xsd.serviceeca.SetDocument.Set.Format target = null;
                target = (com.kyt.xsd.serviceeca.SetDocument.Set.Format)get_store().find_attribute_user(FORMAT$6);
                return target;
            }
        }
         ...
         */
        public void setFormat(com.kyt.xsd.serviceeca.SetDocument.Set.Format.Enum format)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetFormat(com.kyt.xsd.serviceeca.SetDocument.Set.Format format)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (com.kyt.xsd.serviceeca.SetDocument.Set.Format)get_store().add_attribute_user(FORMAT$6);
                }
                target.set(format);
            }
        }
         ...
         */
        public static class FormatImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements com.kyt.xsd.serviceeca.SetDocument.Set.Format
        {
            private static final long serialVersionUID = 1L;
            ...
            protected FormatImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
            {
                super(sType, b);
            }
        }
