 ...
 */
public class ParameterDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgettree.ParameterDocument
{
     ...
     */
    public com.kyt.xsd.widgettree.ParameterDocument.Parameter getParameter()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgettree.ParameterDocument.Parameter target = null;
            target = (com.kyt.xsd.widgettree.ParameterDocument.Parameter)get_store().find_element_user(PARAMETER$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setParameter(com.kyt.xsd.widgettree.ParameterDocument.Parameter parameter)
    {
     ...
     */
    public com.kyt.xsd.widgettree.ParameterDocument.Parameter addNewParameter()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgettree.ParameterDocument.Parameter target = null;
            target = (com.kyt.xsd.widgettree.ParameterDocument.Parameter)get_store().add_element_user(PARAMETER$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class ParameterImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgettree.ParameterDocument.Parameter
    {
        private static final long serialVersionUID = 1L;
