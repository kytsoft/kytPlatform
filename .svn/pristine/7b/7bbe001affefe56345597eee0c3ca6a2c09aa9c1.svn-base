 ...
 */
public class LimitRangeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetform.LimitRangeDocument
{
    ...
    public com.kyt.xsd.widgetform.LimitRangeDocument.LimitRange getLimitRange()
    {
        synchronized (monitor())
        {
            ...
            target = (com.kyt.xsd.widgetform.LimitRangeDocument.LimitRange)get_store().find_element_user(LIMITRANGE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.kyt.xsd.widgetform.LimitRangeDocument.LimitRange addNewLimitRange()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetform.LimitRangeDocument.LimitRange target = null;
            target = (com.kyt.xsd.widgetform.LimitRangeDocument.LimitRange)get_store().add_element_user(LIMITRANGE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class LimitRangeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetform.LimitRangeDocument.LimitRange
    {
        private static final long serialVersionUID = 1L;
