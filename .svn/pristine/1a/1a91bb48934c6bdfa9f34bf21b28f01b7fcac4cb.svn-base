 ...
 */
public class IfValidateMethodDocumentImpl extends com.kyt.xsd.widgetscreen.impl.AllConditionalsDocumentImpl implements com.kyt.xsd.widgetscreen.IfValidateMethodDocument
{
     ...
     */
    public com.kyt.xsd.widgetscreen.IfValidateMethodDocument.IfValidateMethod getIfValidateMethod()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.IfValidateMethodDocument.IfValidateMethod target = null;
            target = (com.kyt.xsd.widgetscreen.IfValidateMethodDocument.IfValidateMethod)get_store().find_element_user(IFVALIDATEMETHOD$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setIfValidateMethod(com.kyt.xsd.widgetscreen.IfValidateMethodDocument.IfValidateMethod ifValidateMethod)
    {
     ...
     */
    public com.kyt.xsd.widgetscreen.IfValidateMethodDocument.IfValidateMethod addNewIfValidateMethod()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.IfValidateMethodDocument.IfValidateMethod target = null;
            target = (com.kyt.xsd.widgetscreen.IfValidateMethodDocument.IfValidateMethod)get_store().add_element_user(IFVALIDATEMETHOD$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class IfValidateMethodImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetscreen.IfValidateMethodDocument.IfValidateMethod
    {
        private static final long serialVersionUID = 1L;
        ...
        public org.apache.xmlbeans.XmlString xgetClass1()
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.XmlString)get_default_attribute_value(CLASS1$4);
                }
                return target;
            }
        }
