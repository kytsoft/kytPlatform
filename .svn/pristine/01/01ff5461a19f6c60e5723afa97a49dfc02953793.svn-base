 ...
 */
public class XorDocumentImpl extends com.kyt.xsd.widgetscreen.impl.AllConditionalsDocumentImpl implements com.kyt.xsd.widgetscreen.XorDocument
{
     ...
     */
    public com.kyt.xsd.widgetscreen.XorDocument.Xor getXor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.XorDocument.Xor target = null;
            target = (com.kyt.xsd.widgetscreen.XorDocument.Xor)get_store().find_element_user(XOR$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setXor(com.kyt.xsd.widgetscreen.XorDocument.Xor xor)
    {
     ...
     */
    public com.kyt.xsd.widgetscreen.XorDocument.Xor addNewXor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.XorDocument.Xor target = null;
            target = (com.kyt.xsd.widgetscreen.XorDocument.Xor)get_store().add_element_user(XOR$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class XorImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetscreen.XorDocument.Xor
    {
        private static final long serialVersionUID = 1L;
