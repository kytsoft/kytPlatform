 ...
 */
public class AndDocumentImpl extends com.kyt.xsd.widgetmenu.impl.AllConditionalsDocumentImpl implements com.kyt.xsd.widgetmenu.AndDocument
{
     ...
     */
    public com.kyt.xsd.widgetmenu.AndDocument.And getAnd()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetmenu.AndDocument.And target = null;
            target = (com.kyt.xsd.widgetmenu.AndDocument.And)get_store().find_element_user(AND$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAnd(com.kyt.xsd.widgetmenu.AndDocument.And and)
    {
     ...
     */
    public com.kyt.xsd.widgetmenu.AndDocument.And addNewAnd()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetmenu.AndDocument.And target = null;
            target = (com.kyt.xsd.widgetmenu.AndDocument.And)get_store().add_element_user(AND$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class AndImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetmenu.AndDocument.And
    {
        private static final long serialVersionUID = 1L;
