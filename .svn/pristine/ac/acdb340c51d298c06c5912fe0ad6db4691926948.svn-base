 ...
 */
public class NotDocumentImpl extends com.kyt.xsd.widgetmenu.impl.AllConditionalsDocumentImpl implements com.kyt.xsd.widgetmenu.NotDocument
{
     ...
     */
    public com.kyt.xsd.widgetmenu.NotDocument.Not getNot()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetmenu.NotDocument.Not target = null;
            target = (com.kyt.xsd.widgetmenu.NotDocument.Not)get_store().find_element_user(NOT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setNot(com.kyt.xsd.widgetmenu.NotDocument.Not not)
    {
     ...
     */
    public com.kyt.xsd.widgetmenu.NotDocument.Not addNewNot()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetmenu.NotDocument.Not target = null;
            target = (com.kyt.xsd.widgetmenu.NotDocument.Not)get_store().add_element_user(NOT$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class NotImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetmenu.NotDocument.Not
    {
        private static final long serialVersionUID = 1L;
