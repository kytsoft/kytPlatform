 ...
 */
public class OrDocumentImpl extends com.kyt.xsd.simplemethods.impl.IfCombineConditionsDocumentImpl implements com.kyt.xsd.simplemethods.OrDocument
{
     ...
     * Gets the "or" element
     */
    public com.kyt.xsd.simplemethods.OrDocument.Or getOr()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.simplemethods.OrDocument.Or target = null;
            target = (com.kyt.xsd.simplemethods.OrDocument.Or)get_store().find_element_user(OR$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     * Sets the "or" element
     */
    public void setOr(com.kyt.xsd.simplemethods.OrDocument.Or or)
    {
     ...
     */
    public com.kyt.xsd.simplemethods.OrDocument.Or addNewOr()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.simplemethods.OrDocument.Or target = null;
            target = (com.kyt.xsd.simplemethods.OrDocument.Or)get_store().add_element_user(OR$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class OrImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.simplemethods.OrDocument.Or
    {
        private static final long serialVersionUID = 1L;
