 ...
 */
public class XorDocumentImpl extends com.kyt.xsd.simplemethods.impl.IfCombineConditionsDocumentImpl implements com.kyt.xsd.simplemethods.XorDocument
{
     ...
     */
    public com.kyt.xsd.simplemethods.XorDocument.Xor getXor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.simplemethods.XorDocument.Xor target = null;
            target = (com.kyt.xsd.simplemethods.XorDocument.Xor)get_store().find_element_user(XOR$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setXor(com.kyt.xsd.simplemethods.XorDocument.Xor xor)
    {
     ...
     */
    public com.kyt.xsd.simplemethods.XorDocument.Xor addNewXor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.simplemethods.XorDocument.Xor target = null;
            target = (com.kyt.xsd.simplemethods.XorDocument.Xor)get_store().add_element_user(XOR$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class XorImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.simplemethods.XorDocument.Xor
    {
        private static final long serialVersionUID = 1L;
