 ...
 */
public class UseIteratorDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.simplemethods.UseIteratorDocument
{
    ...
    public com.kyt.xsd.simplemethods.UseIteratorDocument.UseIterator getUseIterator()
    {
        synchronized (monitor())
        {
            ...
            target = (com.kyt.xsd.simplemethods.UseIteratorDocument.UseIterator)get_store().find_element_user(USEITERATOR$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.kyt.xsd.simplemethods.UseIteratorDocument.UseIterator addNewUseIterator()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.simplemethods.UseIteratorDocument.UseIterator target = null;
            target = (com.kyt.xsd.simplemethods.UseIteratorDocument.UseIterator)get_store().add_element_user(USEITERATOR$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class UseIteratorImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.simplemethods.UseIteratorDocument.UseIterator
    {
        private static final long serialVersionUID = 1L;
