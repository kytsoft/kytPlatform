 ...
 */
public class ErrorSuffixDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.simplemethods.ErrorSuffixDocument
{
    private static final long serialVersionUID = 1L;
    
    public ErrorSuffixDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName ERRORSUFFIX$0 = 
        new javax.xml.namespace.QName("", "error-suffix");
    
    
    /**
     * Gets the "error-suffix" element
     */
    public com.kyt.xsd.simplemethods.ErrorSuffixDocument.ErrorSuffix getErrorSuffix()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.simplemethods.ErrorSuffixDocument.ErrorSuffix target = null;
            target = (com.kyt.xsd.simplemethods.ErrorSuffixDocument.ErrorSuffix)get_store().find_element_user(ERRORSUFFIX$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setErrorSuffix(com.kyt.xsd.simplemethods.ErrorSuffixDocument.ErrorSuffix errorSuffix)
    {
        generatedSetterHelperImpl(errorSuffix, ERRORSUFFIX$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "error-suffix" element
     */
    public com.kyt.xsd.simplemethods.ErrorSuffixDocument.ErrorSuffix addNewErrorSuffix()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.simplemethods.ErrorSuffixDocument.ErrorSuffix target = null;
            target = (com.kyt.xsd.simplemethods.ErrorSuffixDocument.ErrorSuffix)get_store().add_element_user(ERRORSUFFIX$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class ErrorSuffixImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.simplemethods.ErrorSuffixDocument.ErrorSuffix
    {
        private static final long serialVersionUID = 1L;
        
        public ErrorSuffixImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
