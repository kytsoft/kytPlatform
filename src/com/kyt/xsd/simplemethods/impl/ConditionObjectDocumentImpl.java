 ...
 */
public class ConditionObjectDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.simplemethods.ConditionObjectDocument
{
    private static final long serialVersionUID = 1L;
    
    public ConditionObjectDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName CONDITIONOBJECT$0 = 
    ...
    public com.kyt.xsd.simplemethods.ConditionObjectDocument.ConditionObject getConditionObject()
    {
        synchronized (monitor())
        {
            ...
            target = (com.kyt.xsd.simplemethods.ConditionObjectDocument.ConditionObject)get_store().find_element_user(CONDITIONOBJECT$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(conditionObject, CONDITIONOBJECT$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.kyt.xsd.simplemethods.ConditionObjectDocument.ConditionObject addNewConditionObject()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.simplemethods.ConditionObjectDocument.ConditionObject target = null;
            target = (com.kyt.xsd.simplemethods.ConditionObjectDocument.ConditionObject)get_store().add_element_user(CONDITIONOBJECT$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class ConditionObjectImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.simplemethods.ConditionObjectDocument.ConditionObject
    {
        private static final long serialVersionUID = 1L;
        
        public ConditionObjectImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
