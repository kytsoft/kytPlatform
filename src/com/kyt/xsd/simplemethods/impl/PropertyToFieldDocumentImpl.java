 ...
 */
public class PropertyToFieldDocumentImpl extends com.kyt.xsd.simplemethods.impl.OtherOperationsDocumentImpl implements com.kyt.xsd.simplemethods.PropertyToFieldDocument
{
     ...
     */
    public com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField getPropertyToField()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField target = null;
            target = (com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField)get_store().find_element_user(PROPERTYTOFIELD$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPropertyToField(com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField propertyToField)
    {
     ...
     */
    public com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField addNewPropertyToField()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField target = null;
            target = (com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField)get_store().add_element_user(PROPERTYTOFIELD$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class PropertyToFieldImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField.NoLocale.Enum getNoLocale()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField.NoLocale.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField.NoLocale xgetNoLocale()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField.NoLocale target = null;
                target = (com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField.NoLocale)get_store().find_attribute_user(NOLOCALE$8);
                if (target == null)
                {
                    target = (com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField.NoLocale)get_default_attribute_value(NOLOCALE$8);
                }
                return target;
            }
        }
         ...
         */
        public void setNoLocale(com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField.NoLocale.Enum noLocale)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetNoLocale(com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField.NoLocale noLocale)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField.NoLocale)get_store().add_attribute_user(NOLOCALE$8);
                }
                target.set(noLocale);
            }
        }
         ...
         */
        public static class NoLocaleImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements com.kyt.xsd.simplemethods.PropertyToFieldDocument.PropertyToField.NoLocale
        {
            private static final long serialVersionUID = 1L;
