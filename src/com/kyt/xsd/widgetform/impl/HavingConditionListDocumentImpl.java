 ...
 */
public class HavingConditionListDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetform.HavingConditionListDocument
{
    ...
    public com.kyt.xsd.widgetform.HavingConditionListDocument.HavingConditionList getHavingConditionList()
    {
        synchronized (monitor())
        {
            ...
            target = (com.kyt.xsd.widgetform.HavingConditionListDocument.HavingConditionList)get_store().find_element_user(HAVINGCONDITIONLIST$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.kyt.xsd.widgetform.HavingConditionListDocument.HavingConditionList addNewHavingConditionList()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetform.HavingConditionListDocument.HavingConditionList target = null;
            target = (com.kyt.xsd.widgetform.HavingConditionListDocument.HavingConditionList)get_store().add_element_user(HAVINGCONDITIONLIST$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class HavingConditionListImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetform.HavingConditionListDocument.HavingConditionList
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public com.kyt.xsd.widgetform.HavingConditionListDocument.HavingConditionList.Combine.Enum getCombine()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (com.kyt.xsd.widgetform.HavingConditionListDocument.HavingConditionList.Combine.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public com.kyt.xsd.widgetform.HavingConditionListDocument.HavingConditionList.Combine xgetCombine()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.kyt.xsd.widgetform.HavingConditionListDocument.HavingConditionList.Combine target = null;
                target = (com.kyt.xsd.widgetform.HavingConditionListDocument.HavingConditionList.Combine)get_store().find_attribute_user(COMBINE$6);
                if (target == null)
                {
                    target = (com.kyt.xsd.widgetform.HavingConditionListDocument.HavingConditionList.Combine)get_default_attribute_value(COMBINE$6);
                }
                return target;
            }
        }
         ...
         */
        public void setCombine(com.kyt.xsd.widgetform.HavingConditionListDocument.HavingConditionList.Combine.Enum combine)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetCombine(com.kyt.xsd.widgetform.HavingConditionListDocument.HavingConditionList.Combine combine)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (com.kyt.xsd.widgetform.HavingConditionListDocument.HavingConditionList.Combine)get_store().add_attribute_user(COMBINE$6);
                }
                target.set(combine);
            }
        }
         ...
         */
        public static class CombineImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements com.kyt.xsd.widgetform.HavingConditionListDocument.HavingConditionList.Combine
        {
            private static final long serialVersionUID = 1L;
