 ...
 * Localname: password
 * Namespace: 
 * Java type: com.kyt.xsd.widgetform.PasswordDocument
 *
 * Automatically generated - do not modify.
 */
package com.kyt.xsd.widgetform.impl;
/**
 * A document containing one password(@) element.
 *
 * This is a complex type.
 */
public class PasswordDocumentImpl extends com.kyt.xsd.widgetform.impl.AllFieldsDocumentImpl implements com.kyt.xsd.widgetform.PasswordDocument
{
     ...
     */
    public com.kyt.xsd.widgetform.PasswordDocument.Password getPassword()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetform.PasswordDocument.Password target = null;
            target = (com.kyt.xsd.widgetform.PasswordDocument.Password)get_store().find_element_user(PASSWORD$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPassword(com.kyt.xsd.widgetform.PasswordDocument.Password password)
    {
        generatedSetterHelperImpl(password, PASSWORD$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "password" element
     */
    public com.kyt.xsd.widgetform.PasswordDocument.Password addNewPassword()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetform.PasswordDocument.Password target = null;
            target = (com.kyt.xsd.widgetform.PasswordDocument.Password)get_store().add_element_user(PASSWORD$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class PasswordImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetform.PasswordDocument.Password
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public com.kyt.xsd.widgetform.PasswordDocument.Password.ClientAutocompleteField.Enum getClientAutocompleteField()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (com.kyt.xsd.widgetform.PasswordDocument.Password.ClientAutocompleteField.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public com.kyt.xsd.widgetform.PasswordDocument.Password.ClientAutocompleteField xgetClientAutocompleteField()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.kyt.xsd.widgetform.PasswordDocument.Password.ClientAutocompleteField target = null;
                target = (com.kyt.xsd.widgetform.PasswordDocument.Password.ClientAutocompleteField)get_store().find_attribute_user(CLIENTAUTOCOMPLETEFIELD$8);
                if (target == null)
                {
                    target = (com.kyt.xsd.widgetform.PasswordDocument.Password.ClientAutocompleteField)get_default_attribute_value(CLIENTAUTOCOMPLETEFIELD$8);
                }
                return target;
            }
        }
         ...
         */
        public void setClientAutocompleteField(com.kyt.xsd.widgetform.PasswordDocument.Password.ClientAutocompleteField.Enum clientAutocompleteField)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetClientAutocompleteField(com.kyt.xsd.widgetform.PasswordDocument.Password.ClientAutocompleteField clientAutocompleteField)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (com.kyt.xsd.widgetform.PasswordDocument.Password.ClientAutocompleteField)get_store().add_attribute_user(CLIENTAUTOCOMPLETEFIELD$8);
                }
         ...
         *
         * This is an atomic type that is a restriction of com.kyt.xsd.widgetform.PasswordDocument$Password$ClientAutocompleteField.
         */
        public static class ClientAutocompleteFieldImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements com.kyt.xsd.widgetform.PasswordDocument.Password.ClientAutocompleteField
        {
            private static final long serialVersionUID = 1L;
