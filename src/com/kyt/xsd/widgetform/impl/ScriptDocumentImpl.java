 ...
 */
public class ScriptDocumentImpl extends com.kyt.xsd.widgetform.impl.AllActionsDocumentImpl implements com.kyt.xsd.widgetform.ScriptDocument
{
     ...
     */
    public com.kyt.xsd.widgetform.ScriptDocument.Script getScript()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetform.ScriptDocument.Script target = null;
            target = (com.kyt.xsd.widgetform.ScriptDocument.Script)get_store().find_element_user(SCRIPT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setScript(com.kyt.xsd.widgetform.ScriptDocument.Script script)
    {
     ...
     */
    public com.kyt.xsd.widgetform.ScriptDocument.Script addNewScript()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetform.ScriptDocument.Script target = null;
            target = (com.kyt.xsd.widgetform.ScriptDocument.Script)get_store().add_element_user(SCRIPT$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class ScriptImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetform.ScriptDocument.Script
    {
        private static final long serialVersionUID = 1L;
