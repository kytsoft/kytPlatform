 ...
 */
public class ConditionObjectDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetform.ConditionObjectDocument
{
    ...
    public com.kyt.xsd.widgetform.ConditionObjectDocument.ConditionObject getConditionObject()
    {
        synchronized (monitor())
        {
            ...
            target = (com.kyt.xsd.widgetform.ConditionObjectDocument.ConditionObject)get_store().find_element_user(CONDITIONOBJECT$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.kyt.xsd.widgetform.ConditionObjectDocument.ConditionObject addNewConditionObject()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetform.ConditionObjectDocument.ConditionObject target = null;
            target = (com.kyt.xsd.widgetform.ConditionObjectDocument.ConditionObject)get_store().add_element_user(CONDITIONOBJECT$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class ConditionObjectImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetform.ConditionObjectDocument.ConditionObject
    {
        private static final long serialVersionUID = 1L;
