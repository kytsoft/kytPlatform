 ...
 */
public class GetRelatedOneDocumentImpl extends com.kyt.xsd.widgetscreen.impl.AllActionsDocumentImpl implements com.kyt.xsd.widgetscreen.GetRelatedOneDocument
{
     ...
     */
    public com.kyt.xsd.widgetscreen.GetRelatedOneDocument.GetRelatedOne getGetRelatedOne()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.GetRelatedOneDocument.GetRelatedOne target = null;
            target = (com.kyt.xsd.widgetscreen.GetRelatedOneDocument.GetRelatedOne)get_store().find_element_user(GETRELATEDONE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetRelatedOne(com.kyt.xsd.widgetscreen.GetRelatedOneDocument.GetRelatedOne getRelatedOne)
    {
     ...
     */
    public com.kyt.xsd.widgetscreen.GetRelatedOneDocument.GetRelatedOne addNewGetRelatedOne()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.GetRelatedOneDocument.GetRelatedOne target = null;
            target = (com.kyt.xsd.widgetscreen.GetRelatedOneDocument.GetRelatedOne)get_store().add_element_user(GETRELATEDONE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class GetRelatedOneImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetscreen.GetRelatedOneDocument.GetRelatedOne
    {
        private static final long serialVersionUID = 1L;
