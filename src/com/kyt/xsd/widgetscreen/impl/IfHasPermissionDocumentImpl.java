 ...
 */
public class IfHasPermissionDocumentImpl extends com.kyt.xsd.widgetscreen.impl.AllConditionalsDocumentImpl implements com.kyt.xsd.widgetscreen.IfHasPermissionDocument
{
     ...
     */
    public com.kyt.xsd.widgetscreen.IfHasPermissionDocument.IfHasPermission getIfHasPermission()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.IfHasPermissionDocument.IfHasPermission target = null;
            target = (com.kyt.xsd.widgetscreen.IfHasPermissionDocument.IfHasPermission)get_store().find_element_user(IFHASPERMISSION$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setIfHasPermission(com.kyt.xsd.widgetscreen.IfHasPermissionDocument.IfHasPermission ifHasPermission)
    {
     ...
     */
    public com.kyt.xsd.widgetscreen.IfHasPermissionDocument.IfHasPermission addNewIfHasPermission()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.IfHasPermissionDocument.IfHasPermission target = null;
            target = (com.kyt.xsd.widgetscreen.IfHasPermissionDocument.IfHasPermission)get_store().add_element_user(IFHASPERMISSION$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class IfHasPermissionImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetscreen.IfHasPermissionDocument.IfHasPermission
    {
        private static final long serialVersionUID = 1L;
