 ...
 */
public class UseIteratorDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetscreen.UseIteratorDocument
{
    ...
    public com.kyt.xsd.widgetscreen.UseIteratorDocument.UseIterator getUseIterator()
    {
        synchronized (monitor())
        {
            ...
            target = (com.kyt.xsd.widgetscreen.UseIteratorDocument.UseIterator)get_store().find_element_user(USEITERATOR$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.kyt.xsd.widgetscreen.UseIteratorDocument.UseIterator addNewUseIterator()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.UseIteratorDocument.UseIterator target = null;
            target = (com.kyt.xsd.widgetscreen.UseIteratorDocument.UseIterator)get_store().add_element_user(USEITERATOR$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class UseIteratorImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetscreen.UseIteratorDocument.UseIterator
    {
        private static final long serialVersionUID = 1L;
