 ...
 */
public class ScriptDocumentImpl extends com.kyt.xsd.widgetscreen.impl.AllActionsDocumentImpl implements com.kyt.xsd.widgetscreen.ScriptDocument
{
     ...
     */
    public com.kyt.xsd.widgetscreen.ScriptDocument.Script getScript()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.ScriptDocument.Script target = null;
            target = (com.kyt.xsd.widgetscreen.ScriptDocument.Script)get_store().find_element_user(SCRIPT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setScript(com.kyt.xsd.widgetscreen.ScriptDocument.Script script)
    {
     ...
     */
    public com.kyt.xsd.widgetscreen.ScriptDocument.Script addNewScript()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.ScriptDocument.Script target = null;
            target = (com.kyt.xsd.widgetscreen.ScriptDocument.Script)get_store().add_element_user(SCRIPT$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class ScriptImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetscreen.ScriptDocument.Script
    {
        private static final long serialVersionUID = 1L;
