 ...
 */
public class ActionsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetscreen.ActionsDocument
{
    ...
    public com.kyt.xsd.widgetscreen.ActionsDocument.Actions getActions()
    {
        synchronized (monitor())
        {
            ...
            target = (com.kyt.xsd.widgetscreen.ActionsDocument.Actions)get_store().find_element_user(ACTIONS$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.kyt.xsd.widgetscreen.ActionsDocument.Actions addNewActions()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.ActionsDocument.Actions target = null;
            target = (com.kyt.xsd.widgetscreen.ActionsDocument.Actions)get_store().add_element_user(ACTIONS$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class ActionsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetscreen.ActionsDocument.Actions
    {
        private static final long serialVersionUID = 1L;
