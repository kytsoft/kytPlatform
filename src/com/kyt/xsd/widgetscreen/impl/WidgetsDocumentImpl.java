 ...
 * Localname: widgets
 * Namespace: 
 * Java type: com.kyt.xsd.widgetscreen.WidgetsDocument
 *
 * Automatically generated - do not modify.
 */
package com.kyt.xsd.widgetscreen.impl;
/**
 * A document containing one widgets(@) element.
 *
 * This is a complex type.
 */
public class WidgetsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetscreen.WidgetsDocument
{
    private static final long serialVersionUID = 1L;
    
    public WidgetsDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName WIDGETS$0 = 
    ...
    public com.kyt.xsd.widgetscreen.WidgetsDocument.Widgets getWidgets()
    {
        synchronized (monitor())
        {
            ...
            target = (com.kyt.xsd.widgetscreen.WidgetsDocument.Widgets)get_store().find_element_user(WIDGETS$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(widgets, WIDGETS$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.kyt.xsd.widgetscreen.WidgetsDocument.Widgets addNewWidgets()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.WidgetsDocument.Widgets target = null;
            target = (com.kyt.xsd.widgetscreen.WidgetsDocument.Widgets)get_store().add_element_user(WIDGETS$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class WidgetsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetscreen.WidgetsDocument.Widgets
    {
        private static final long serialVersionUID = 1L;
        
        public WidgetsImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
