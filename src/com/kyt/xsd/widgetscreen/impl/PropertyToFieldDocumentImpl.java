 ...
 * Namespace: 
 * Java type: com.kyt.xsd.widgetscreen.PropertyToFieldDocument
 *
 ...
 */
public class PropertyToFieldDocumentImpl extends com.kyt.xsd.widgetscreen.impl.AllActionsDocumentImpl implements com.kyt.xsd.widgetscreen.PropertyToFieldDocument
{
     ...
     */
    public com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField getPropertyToField()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField target = null;
            target = (com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField)get_store().find_element_user(PROPERTYTOFIELD$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPropertyToField(com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField propertyToField)
    {
     ...
     */
    public com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField addNewPropertyToField()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField target = null;
            target = (com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField)get_store().add_element_user(PROPERTYTOFIELD$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class PropertyToFieldImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField.NoLocale.Enum getNoLocale()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField.NoLocale.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField.NoLocale xgetNoLocale()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField.NoLocale target = null;
                target = (com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField.NoLocale)get_store().find_attribute_user(NOLOCALE$8);
                if (target == null)
                {
                    target = (com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField.NoLocale)get_default_attribute_value(NOLOCALE$8);
                }
                return target;
            }
        }
         ...
         */
        public void setNoLocale(com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField.NoLocale.Enum noLocale)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetNoLocale(com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField.NoLocale noLocale)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField.NoLocale)get_store().add_attribute_user(NOLOCALE$8);
                }
                target.set(noLocale);
            }
        }
         ...
         * An XML no-locale(@).
         *
         * This is an atomic type that is a restriction of com.kyt.xsd.widgetscreen.PropertyToFieldDocument$PropertyToField$NoLocale.
         */
        public static class NoLocaleImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements com.kyt.xsd.widgetscreen.PropertyToFieldDocument.PropertyToField.NoLocale
        {
            private static final long serialVersionUID = 1L;
