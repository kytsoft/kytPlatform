 ...
 */
public class FailPropertyDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.services.FailPropertyDocument
{
     ...
     */
    public com.kyt.xsd.services.FailPropertyDocument.FailProperty getFailProperty()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.services.FailPropertyDocument.FailProperty target = null;
            target = (com.kyt.xsd.services.FailPropertyDocument.FailProperty)get_store().find_element_user(FAILPROPERTY$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setFailProperty(com.kyt.xsd.services.FailPropertyDocument.FailProperty failProperty)
    {
     ...
     */
    public com.kyt.xsd.services.FailPropertyDocument.FailProperty addNewFailProperty()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.services.FailPropertyDocument.FailProperty target = null;
            target = (com.kyt.xsd.services.FailPropertyDocument.FailProperty)get_store().add_element_user(FAILPROPERTY$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class FailPropertyImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.services.FailPropertyDocument.FailProperty
    {
        private static final long serialVersionUID = 1L;
