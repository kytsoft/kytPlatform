 ...
 */
public class SelectFieldDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgettree.SelectFieldDocument
{
     ...
     */
    public com.kyt.xsd.widgettree.SelectFieldDocument.SelectField getSelectField()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgettree.SelectFieldDocument.SelectField target = null;
            target = (com.kyt.xsd.widgettree.SelectFieldDocument.SelectField)get_store().find_element_user(SELECTFIELD$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSelectField(com.kyt.xsd.widgettree.SelectFieldDocument.SelectField selectField)
    {
    ...
    public com.kyt.xsd.widgettree.SelectFieldDocument.SelectField addNewSelectField()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgettree.SelectFieldDocument.SelectField target = null;
            target = (com.kyt.xsd.widgettree.SelectFieldDocument.SelectField)get_store().add_element_user(SELECTFIELD$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class SelectFieldImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgettree.SelectFieldDocument.SelectField
    {
        private static final long serialVersionUID = 1L;
