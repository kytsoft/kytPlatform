 ...
 */
public class IfHasPermissionDocumentImpl extends com.kyt.xsd.widgettree.impl.AllConditionalsDocumentImpl implements com.kyt.xsd.widgettree.IfHasPermissionDocument
{
     ...
     */
    public com.kyt.xsd.widgettree.IfHasPermissionDocument.IfHasPermission getIfHasPermission()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgettree.IfHasPermissionDocument.IfHasPermission target = null;
            target = (com.kyt.xsd.widgettree.IfHasPermissionDocument.IfHasPermission)get_store().find_element_user(IFHASPERMISSION$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setIfHasPermission(com.kyt.xsd.widgettree.IfHasPermissionDocument.IfHasPermission ifHasPermission)
    {
     ...
     */
    public com.kyt.xsd.widgettree.IfHasPermissionDocument.IfHasPermission addNewIfHasPermission()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgettree.IfHasPermissionDocument.IfHasPermission target = null;
            target = (com.kyt.xsd.widgettree.IfHasPermissionDocument.IfHasPermission)get_store().add_element_user(IFHASPERMISSION$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class IfHasPermissionImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgettree.IfHasPermissionDocument.IfHasPermission
    {
        private static final long serialVersionUID = 1L;
