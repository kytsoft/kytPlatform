 ...
 */
public class LimitViewDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgettree.LimitViewDocument
{
    ...
    public com.kyt.xsd.widgettree.LimitViewDocument.LimitView getLimitView()
    {
        synchronized (monitor())
        {
            ...
            target = (com.kyt.xsd.widgettree.LimitViewDocument.LimitView)get_store().find_element_user(LIMITVIEW$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.kyt.xsd.widgettree.LimitViewDocument.LimitView addNewLimitView()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgettree.LimitViewDocument.LimitView target = null;
            target = (com.kyt.xsd.widgettree.LimitViewDocument.LimitView)get_store().add_element_user(LIMITVIEW$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class LimitViewImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgettree.LimitViewDocument.LimitView
    {
        private static final long serialVersionUID = 1L;
