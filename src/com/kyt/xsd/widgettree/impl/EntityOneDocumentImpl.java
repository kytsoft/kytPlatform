 ...
 */
public class EntityOneDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgettree.EntityOneDocument
{
    private static final long serialVersionUID = 1L;
    
    public EntityOneDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName ENTITYONE$0 = 
     ...
     */
    public com.kyt.xsd.widgettree.EntityOneDocument.EntityOne getEntityOne()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgettree.EntityOneDocument.EntityOne target = null;
            target = (com.kyt.xsd.widgettree.EntityOneDocument.EntityOne)get_store().find_element_user(ENTITYONE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setEntityOne(com.kyt.xsd.widgettree.EntityOneDocument.EntityOne entityOne)
    {
        generatedSetterHelperImpl(entityOne, ENTITYONE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "entity-one" element
     */
    public com.kyt.xsd.widgettree.EntityOneDocument.EntityOne addNewEntityOne()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.kyt.xsd.widgettree.EntityOneDocument.EntityOne target = null;
            target = (com.kyt.xsd.widgettree.EntityOneDocument.EntityOne)get_store().add_element_user(ENTITYONE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class EntityOneImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.kyt.xsd.widgettree.EntityOneDocument.EntityOne
    {
        private static final long serialVersionUID = 1L;
        
        public EntityOneImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        private static final javax.xml.namespace.QName VALUEFIELD$6 = 
        ...
        private static final javax.xml.namespace.QName AUTOFIELDMAP$10 = 
        ...
        public com.kyt.xsd.widgettree.SelectFieldDocument.SelectField getSelectFieldArray(int i)
        {
            synchronized (monitor())
            {
                ...
                target = (com.kyt.xsd.widgettree.SelectFieldDocument.SelectField)get_store().find_element_user(SELECTFIELD$2, i);
                if (target == null)
                {
                    throw new IndexOutOfBoundsException();
                }
        ...
        public com.kyt.xsd.widgettree.SelectFieldDocument.SelectField insertNewSelectField(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.kyt.xsd.widgettree.SelectFieldDocument.SelectField target = null;
                target = (com.kyt.xsd.widgettree.SelectFieldDocument.SelectField)get_store().insert_element_user(SELECTFIELD$2, i);
                return target;
            }
        }
        ...
        public com.kyt.xsd.widgettree.SelectFieldDocument.SelectField addNewSelectField()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.kyt.xsd.widgettree.SelectFieldDocument.SelectField target = null;
                target = (com.kyt.xsd.widgettree.SelectFieldDocument.SelectField)get_store().add_element_user(SELECTFIELD$2);
                return target;
            }
        }
        ...
        public java.lang.String getValueField()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(VALUEFIELD$6);
                if (target == null)
                {
                    return null;
                }
        ...
        public org.apache.xmlbeans.XmlString xgetValueField()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.XmlString target = null;
                target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(VALUEFIELD$6);
                return target;
            }
        }
        ...
        public boolean isSetValueField()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(VALUEFIELD$6) != null;
            }
        }
        ...
        public void setValueField(java.lang.String valueField)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(VALUEFIELD$6);
                }
        ...
        public void xsetValueField(org.apache.xmlbeans.XmlString valueField)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(VALUEFIELD$6);
                }
        ...
        public void unsetValueField()
        {
            ...
            {
                check_orphaned();
                get_store().remove_attribute(VALUEFIELD$6);
            }
        }
         ...
         */
        public com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.UseCache.Enum getUseCache()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.UseCache.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.UseCache xgetUseCache()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.UseCache target = null;
                target = (com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.UseCache)get_store().find_attribute_user(USECACHE$8);
                if (target == null)
                {
                    target = (com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.UseCache)get_default_attribute_value(USECACHE$8);
                }
                return target;
            }
        }
         ...
         */
        public void setUseCache(com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.UseCache.Enum useCache)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetUseCache(com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.UseCache useCache)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.UseCache)get_store().add_attribute_user(USECACHE$8);
                }
                target.set(useCache);
            }
        }
         ...
         */
        public com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.AutoFieldMap.Enum getAutoFieldMap()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(AUTOFIELDMAP$10);
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(AUTOFIELDMAP$10);
                }
                if (target == null)
                {
                    return null;
                }
                return (com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.AutoFieldMap.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.AutoFieldMap xgetAutoFieldMap()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.AutoFieldMap target = null;
                target = (com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.AutoFieldMap)get_store().find_attribute_user(AUTOFIELDMAP$10);
                if (target == null)
                {
                    target = (com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.AutoFieldMap)get_default_attribute_value(AUTOFIELDMAP$10);
                }
                return target;
            }
        }
        ...
        public boolean isSetAutoFieldMap()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(AUTOFIELDMAP$10) != null;
            }
        }
         ...
         */
        public void setAutoFieldMap(com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.AutoFieldMap.Enum autoFieldMap)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(AUTOFIELDMAP$10);
                }
                target.setEnumValue(autoFieldMap);
            }
        }
         ...
         */
        public void xsetAutoFieldMap(com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.AutoFieldMap autoFieldMap)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.AutoFieldMap)get_store().add_attribute_user(AUTOFIELDMAP$10);
                }
        ...
        public void unsetAutoFieldMap()
        {
            ...
            {
                check_orphaned();
                get_store().remove_attribute(AUTOFIELDMAP$10);
            }
        }
        /**
         * An XML use-cache(@).
         ...
         */
        public static class UseCacheImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.UseCache
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class AutoFieldMapImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements com.kyt.xsd.widgettree.EntityOneDocument.EntityOne.AutoFieldMap
        {
            private static final long serialVersionUID = 1L;
            
            public AutoFieldMapImpl(org.apache.xmlbeans.SchemaType sType)
            {
                super(sType, false);
            }
            
            protected AutoFieldMapImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
            {
                super(sType, b);
            }
        }
